...
PROMPT_PLACEHOLDERS = {
    ...
    "plan": {"request", "brief_path", "arch_docs"},
    "debate_review": {"task_id", "round", "docs_dir"},
    "debate_ux": {"task_id", "round", "tech_limits", "docs_dir"},
    "debate_reply": {"task_id", "round", "tech_limits", "docs_dir"},
    "summary": {"task_id", "docs_dir"},
    "judge": {"task_id", "docs_dir"},
    "implement": {
        "task_id",
        "batch_n",
        "batch_scope",
    ...
    "code_fix": {"task_id", "batch_n", "docs_dir"},
    "code_verify": {"task_id", "batch_n", "docs_dir"},
    "final_check": {"task_id", "db_note", "docs_dir"},
    "preflight_fix": {"failures", "summary", "remaining_label"},
    "visual_review": {"screens_dir", "render_facts"},
    "visual_fix": {"task_id", "screens_dir", "render_facts", "docs_dir"},
